...
**Step 1.** Add the input scale to each catch-rate sentence. — **DONE** (this commit)

**Step 2.** Add the 95% confidence limits to each rate. Use the Wilson method. — **DONE** for the headline rate; **OPEN** for the Phase 5 table
...
Find the cause of the 4.01 value. — **OPEN** (ERRATA §4)

**Step 7.** Correct the severity numbers and the softmax sentences in the
current documents. Point to this audit. — **DONE** (this commit)

**Step 8.** Remove the unverified sentence about one-time tests from the
current documents. — **DONE** (this commit)

**Step 9.** Write the report (Phase 6). Use the corrected numbers only.
Include this audit as a section. — **OPEN**

**Step 10.** Get an arXiv endorsement. Then submit the report. — **OPEN**

Historical documents keep their errors. `NOTEBOOK.md` is a record and stays
unchanged. Corrections go forward. This is the rule of the repo.
