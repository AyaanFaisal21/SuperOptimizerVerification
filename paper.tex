...
% Rev. 4.1: review-4 fixes, exact separability (E5), frontier figure.
...
scale-matched gaussian inputs and $0/100$ at unit scale, and a simple independence approximation over per-element exceedance is
