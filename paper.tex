...
% Rev. 5a.3: claim audit; every number asserted against the records.
...
contraction widths, against sixteen injected-bug instances, fifty draws
...
committed before every run (the log records eleven falsified by their
own runs), and an errata recording every retracted or corrected result
of our own.
\end{enumerate}
